...
<body>
    <div class="container">
        <br />
        <h3 align="center">Penghuni KOS</h3>
        <br />
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <span id="no_kamar_error" class="text-danger"></span>
                    <br />
                    <label>Nama Penghuni</label>
                    <input type="text" name="nama_penghuni" id="nama_penghuni" class="form-control" />
                    <span id="nama_penghuni_error" class="text-danger"></span>
                    <br />
                    <label>Asal</label>
...
$(document).ready(function(){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>kos_client/action",
            method:"POST",
    ...
    $('#add_button').click(function(){
        $('#user_form')[0].reset();
        $('.modal-title').text("tambah penghuni");
        $('#action').val('Add');
    ...
    $(document).on('submit', '#user_form', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.error)
                {
                    $('#no_kamar_error').html(data.no_kamar_error);
                    $('#nama_penghuni_error').html(data.nama_penghuni_error);
                }
            }
        })
    });
